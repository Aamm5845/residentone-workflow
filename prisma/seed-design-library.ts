...
const DESIGN_LIBRARY = [
  ...
  // PLUMBING FIXTURES
  {
    ...
    items: [
      ...
      { name: 'Sink', icon: 'Bath', description: 'Basin or wash basin' },
      { name: 'Vanity', icon: 'Box', description: 'Bathroom vanity unit' },
      ...
      { name: 'Shower Door', icon: 'DoorClosed', description: 'Glass enclosure' },
      { name: 'Towel Bar', icon: 'Minus', description: 'Towel rack' },
      { name: 'Toilet Paper Holder', icon: 'Circle', description: 'TP holder' },
      { name: 'Kitchen Sink', icon: 'Bath', description: 'Kitchen basin' },
      { name: 'Laundry Sink', icon: 'Bath', description: 'Utility sink' },
    ]
  },
  ...
  // TEXTILES & SOFT GOODS
  {
    ...
    items: [
      { name: 'Curtains', icon: 'SquareDashed', description: 'Window treatments' },
      { name: 'Drapes', icon: 'SquareDashed', description: 'Heavy window coverings' },
      { name: 'Blinds', icon: 'Rows', description: 'Window shades' },
      { name: 'Rug', icon: 'Square', description: 'Area rug' },
      { name: 'Bedding', icon: 'Bed', description: 'Bed linens' },
      { name: 'Throw Pillows', icon: 'Square', description: 'Decorative cushions' },
      { name: 'Throw Blanket', icon: 'Square', description: 'Accent blanket' },
      { name: 'Towels', icon: 'Square', description: 'Bath towels' },
      { name: 'Upholstery', icon: 'Armchair', description: 'Fabric selection' },
    ]
  },
  ...
  // APPLIANCES
  {
    ...
    items: [
      { name: 'Refrigerator', icon: 'Box', description: 'Kitchen fridge' },
      { name: 'Range', icon: 'Flame', description: 'Stove and oven' },
      { name: 'Dishwasher', icon: 'Box', description: 'Built-in dishwasher' },
      { name: 'Microwave', icon: 'Box', description: 'Microwave oven' },
      { name: 'Range Hood', icon: 'Wind', description: 'Ventilation hood' },
      { name: 'Wine Cooler', icon: 'Wine', description: 'Wine refrigerator' },
      { name: 'Washer', icon: 'Box', description: 'Washing machine' },
      { name: 'Dryer', icon: 'Box', description: 'Clothes dryer' },
    ]
  },
  ...
  // HARDWARE & FINISHES
  {
    ...
    items: [
      { name: 'Door Handle', icon: 'DoorClosed', description: 'Door lever or knob' },
      { name: 'Cabinet Hardware', icon: 'Grip', description: 'Pulls and knobs' },
      { name: 'Cabinet Pull', icon: 'Grip', description: 'Drawer pulls' },
      { name: 'Hinges', icon: 'Link', description: 'Door hinges' },
      { name: 'Switch Plate', icon: 'Square', description: 'Light switch cover' },
      { name: 'Outlet Cover', icon: 'Plug', description: 'Electrical plate' },
      { name: 'Curtain Rod', icon: 'Minus', description: 'Drapery hardware' },
      { name: 'Hooks', icon: 'Circle', description: 'Wall hooks' },
    ]
  },
