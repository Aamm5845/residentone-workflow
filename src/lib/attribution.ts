...
export const ActivityActions = {
  ...
  SUPPLIER_QUOTE_APPROVED: 'SUPPLIER_QUOTE_APPROVED',
  SUPPLIER_QUOTE_REJECTED: 'SUPPLIER_QUOTE_REJECTED',

  // Procurement - Client Invoices
  CLIENT_INVOICE_CREATED: 'CLIENT_INVOICE_CREATED',
  CLIENT_INVOICE_UPDATED: 'CLIENT_INVOICE_UPDATED',
  CLIENT_INVOICE_SENT: 'CLIENT_INVOICE_SENT',
  CLIENT_INVOICE_DELETED: 'CLIENT_INVOICE_DELETED',
  CLIENT_INVOICE_PAYMENT_RECEIVED: 'CLIENT_INVOICE_PAYMENT_RECEIVED',
  CLIENT_INVOICE_REMINDER_SENT: 'CLIENT_INVOICE_REMINDER_SENT',

  // Procurement - Budget Quotes
  BUDGET_QUOTE_CREATED: 'BUDGET_QUOTE_CREATED',
  BUDGET_QUOTE_UPDATED: 'BUDGET_QUOTE_UPDATED',
  BUDGET_QUOTE_SENT: 'BUDGET_QUOTE_SENT',
  BUDGET_QUOTE_DELETED: 'BUDGET_QUOTE_DELETED',

  // Contractors
  CONTRACTOR_CREATED: 'CONTRACTOR_CREATED',
  CONTRACTOR_UPDATED: 'CONTRACTOR_UPDATED',
  CONTRACTOR_DELETED: 'CONTRACTOR_DELETED',
  CONTRACTOR_CONTACT_ADDED: 'CONTRACTOR_CONTACT_ADDED',
  CONTRACTOR_CONTACT_UPDATED: 'CONTRACTOR_CONTACT_UPDATED',
  ...
  ITEM_LIBRARY_UPDATED: 'ITEM_LIBRARY_UPDATED',

  // Project Files
  FILE_UPLOADED: 'FILE_UPLOADED',
  FILE_DELETED: 'FILE_DELETED',
  TRANSMITTAL_CREATED: 'TRANSMITTAL_CREATED',
  TRANSMITTAL_SENT: 'TRANSMITTAL_SENT',
