...
const OLD_FOLDER_NAME = '6- SHOPPING'
const NEW_FOLDER_NAME = '8- Shopping'

/**
 * POST /api/admin/rename-shopping-folders
 * Rename "6- SHOPPING" to "8- Shopping" in all existing project Dropbox folders.
 * If the old folder doesn't exist, create "8- Shopping" instead.
 *
 * Body:
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[rename-shopping-folders] Error:', error)
    return NextResponse.json(
